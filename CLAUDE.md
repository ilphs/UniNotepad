...
**UniEditPlus** — 탭 + Notepad++ 스타일 세션 지속성을 갖춘 경량 크로스플랫폼 플레인 텍스트 에디터. 수동 저장 없이도 앱 종료·크래시·컴퓨터 재시작 후 열려 있던 탭(미저장 untitled 포함)이 그대로 복원된다. 주요 확장자 syntax highlighting 지원.
